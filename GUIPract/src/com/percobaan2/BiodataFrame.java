...
public class BiodataFrame extends javax.swing.JFrame {
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        ...
        Object jurusan = jurusanComboBox.getSelectedItem();
        Object gender = genderGroup.getSelection();
        
        StringBuilder err = new StringBuilder();
        err.append("");
        if (nim.equals("")) {
            err.append("Nim Harus Terisi!\n");
        }
        if (nama.equals("")) {
            err.append("Nama harus terisi!\n");
        }
        if (jurusan == null) {
            err.append("Anda Harus Memilih Jurusan!\n");
        }
        if (gender == null) {
            err.append("Anda Harus Memilih Gender\n");
        }
        
        if (!err.toString().equals("")) {
            JOptionPane.showMessageDialog(this, err, "Biodata", JOptionPane.ERROR_MESSAGE);
            return;
        }
